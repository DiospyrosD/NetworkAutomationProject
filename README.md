...
- ```shell
  ansible-playbook create_network.yml # to create the network. If issues occur or the playbook is interrupted, run the 'destroy' playbook before re-installing.
- ```shell
